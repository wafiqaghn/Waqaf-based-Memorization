...
- Ensure you have Node.js 20.9+ installed.
- Ensure Corepack is enabled with `corepack enable`.
- Clone this repo
- Run `pnpm install` on the repo to install `node_modules`
- Run `pnpm dev` to start the app. If you wish to run on a different port, run `pnpm dev -p 8000`
