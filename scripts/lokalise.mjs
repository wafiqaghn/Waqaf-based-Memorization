 ...
 *
 * 1. Pulling all translation files from Lokalize by using the syntax `pnpm run lokalise:pull`.
 * 2. Pushing a specific file for a specific locale to Lokalise by using the syntax `pnpm run lokalise:push {filename} {locale}` e.g. `pnpm run lokalise:push common.json en`.
 */
