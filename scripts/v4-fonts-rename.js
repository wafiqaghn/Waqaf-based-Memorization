 ...
 *
 * Light and sepia OT-SVG assets are intentionally ignored. Runtime font loading
 * uses COLRv1 for those modes and only keeps OT-SVG dark as a Firefox dark-mode fallback.
 */

const FONT_DIRECTORIES = ['COLRv1', 'COLRv1-Dark Mode Firefox', 'OT-SVG DARK'];
