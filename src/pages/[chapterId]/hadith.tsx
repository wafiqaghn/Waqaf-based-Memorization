...
import { fetcher, getAyahHadiths, getPagesLookup } from '@/api';
...
import { getCanonicalUrl, getVerseHadithsNavigationUrl } from '@/utils/navigation';
import {
...
const AyahHadithPage: NextPage<AyahHadithPageProps> = ({
  chapter,
  verseNumber,
  chapterId,
  fallback,
    ...
    <>
      ...
      <SWRConfig value={{ fallback }}>
        <StudyModeSsrContainer
          initialTab={StudyModeTabId.HADITH}
          chapterId={chapterId}
...
export const getStaticProps: GetStaticProps = async ({ params, locale }) => {
  if (process.env.NEXT_PUBLIC_ENABLE_AYAH_EXTRA_PAGES !== 'true') return { notFound: true };
