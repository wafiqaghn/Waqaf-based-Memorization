...
import AboutTheQuranArabic from './AboutTheQuranArabic';
import AboutTheQuranSwahili from './AboutTheQuranSwahili';
...
const AboutQuranPage: NextPage = (): JSX.Element => {
  ...
  const renderContent = () => {
    if (lang === Language.AR) {
      return <AboutTheQuranArabic />;
    }
    if (lang === Language.SW) {
      return <AboutTheQuranSwahili />;
    }
    return (
