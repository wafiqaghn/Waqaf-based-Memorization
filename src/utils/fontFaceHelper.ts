...
const getFontPath = (
  ...
  // TajweedV4 ships as COLRv1 for modern browsers. We keep only the OT-SVG dark
  // fallback because Firefox needs it to render the dark-mode colored glyphs correctly.
  // Light and sepia OT-SVG assets are intentionally not kept: those modes use COLRv1.
 ...
 * generate-font-scales function inside _utility.scss.
 *
 * @param {QuranFont} quranFont
